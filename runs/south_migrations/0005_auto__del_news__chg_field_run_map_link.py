...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Run.map_link'
        db.alter_column('runs_run', 'map_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Run.map_link'
        db.alter_column('runs_run', 'map_link', self.gf('django.db.models.fields.URLField')(max_length=200))
