...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Run.location_text'
        db.delete_column(u'runs_run', 'location_text')

        # Deleting field 'Run.map_link'
        db.delete_column(u'runs_run', 'map_link')

        # Deleting field 'Run.longitude'
        db.delete_column(u'runs_run', 'longitude')

        # Deleting field 'Run.map_iframe'
        db.delete_column(u'runs_run', 'map_iframe')

        # Deleting field 'Run.latitude'
        db.delete_column(u'runs_run', 'latitude')

        # Deleting field 'Run.location'
        db.delete_column(u'runs_run', 'location_id')


    def backwards(self, orm):
        # Adding field 'Run.location_text'
        db.add_column(u'runs_run', 'location_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Run.map_link'
        db.add_column(u'runs_run', 'map_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Run.longitude'
        db.add_column(u'runs_run', 'longitude',
        ...
        db.add_column(u'runs_run', 'map_iframe',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Run.latitude'
        db.add_column(u'runs_run', 'latitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'Run.location'
        db.add_column(u'runs_run', 'location',
    ...
    models = {
        ...
        u'runs.run': {
            'Meta': {'ordering': "['day_of_week']", 'object_name': 'Run'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['members.Member']"}),
