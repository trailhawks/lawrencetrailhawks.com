...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Run.location'
        db.alter_column(u'runs_run', 'location', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Run.location'
        raise RuntimeError("Cannot reverse this migration. 'Run.location' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Run.location'
        db.alter_column(u'runs_run', 'location', self.gf('django.db.models.fields.TextField')())
