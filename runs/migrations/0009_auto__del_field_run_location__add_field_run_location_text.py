...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'Run.location'to 'Run.location_text'
        db.rename_column(u'runs_run', 'location', 'location_text')


    def backwards(self, orm):
        # Rename field 'Run.location_text'to 'Run.location'
        db.rename_column(u'runs_run', 'location_text', 'location')
