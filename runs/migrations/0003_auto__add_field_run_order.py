...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Run.order'
        db.add_column('runs_run', 'order', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Run.order'
        db.delete_column('runs_run', 'order')
    ...
    models = {
        ...
        'runs.run': {
            'Meta': {'ordering': "['order']", 'object_name': 'Run'},
