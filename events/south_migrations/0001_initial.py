...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field races on 'Event'
        m2m_table_name = db.shorten_name(u'events_event_races')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'events.event'], null=False)),
            ('race', models.ForeignKey(orm[u'races.race'], null=False))
        ))
        db.create_unique(m2m_table_name, ['event_id', 'race_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field races on 'Event'
        db.delete_table(db.shorten_name(u'events_event_races'))
    ...
    models = {
        ...
        u'events.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'races': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'events'", 'symmetrical': 'False', 'to': u"orm['races.Race']"}),
