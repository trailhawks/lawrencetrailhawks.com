...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Member.member_since'
        db.add_column('members_member', 'member_since', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Member.member_since'
        db.delete_column('members_member', 'member_since')
