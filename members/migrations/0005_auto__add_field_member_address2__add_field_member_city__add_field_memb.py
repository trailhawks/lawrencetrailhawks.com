...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('members_member', 'city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Member.state'
        db.add_column('members_member', 'state', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('members_member', 'city')

        # Deleting field 'Member.state'
        db.delete_column('members_member', 'state')
