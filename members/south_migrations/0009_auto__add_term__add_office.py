...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Term'
        db.create_table(u'members_term', (
        ...
        db.send_create_signal(u'members', ['Term'])

        # Adding model 'Office'
        db.create_table(u'members_office', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=10)),
        ))
        db.send_create_signal(u'members', ['Office'])


    def backwards(self, orm):
        # Deleting model 'Term'
        db.delete_table(u'members_term')

        # Deleting model 'Office'
        db.delete_table(u'members_office')
