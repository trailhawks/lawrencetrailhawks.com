...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Term.name'
        db.delete_column(u'members_term', 'name')

        # Deleting field 'Term.slug'
        db.delete_column(u'members_term', 'slug')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Term.name'
        raise RuntimeError("Cannot reverse this migration. 'Term.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Term.name'
        db.add_column(u'members_term', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=100),
                      keep_default=False)

        # Adding field 'Term.slug'
        db.add_column(u'members_term', 'slug',
    ...
    models = {
        ...
        u'members.term': {
            ...
            'office': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['members.Office']", 'null': 'True', 'blank': 'True'}),
