...
urlpatterns = patterns('',
    url(r'^$', 'django.views.generic.date_based.archive_index', race_info_dict, 'race_archive_index'),
    ...
    url(r'^racers/(?P<object_id>[-\w]+)/$', 'lawrencetrailhawks.races.views.racer_detail', racer_info_dict, 'racer_detail'),
)
