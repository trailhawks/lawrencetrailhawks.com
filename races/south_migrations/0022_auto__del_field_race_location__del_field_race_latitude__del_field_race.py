...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Race.location'
        db.delete_column(u'races_race', 'location_id')

        # Deleting field 'Race.latitude'
        db.delete_column(u'races_race', 'latitude')

        # Deleting field 'Race.location_text'
        db.delete_column(u'races_race', 'location_text')

        # Deleting field 'Race.map_link'
        db.delete_column(u'races_race', 'map_link')

        # Deleting field 'Race.location_iframe'
        db.delete_column(u'races_race', 'location_iframe')
    ...
    def backwards(self, orm):
        # Adding field 'Race.location'
        db.add_column(u'races_race', 'location',
        ...
        # Adding field 'Race.location_text'
        db.add_column(u'races_race', 'location_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Race.map_link'
        db.add_column(u'races_race', 'map_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Race.location_iframe'
        db.add_column(u'races_race', 'location_iframe',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
