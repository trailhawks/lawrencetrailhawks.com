...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'Race.location'to 'Race.location_text'
        db.rename_column(u'races_race', 'location', 'location_text')


    def backwards(self, orm):
        # Rename field 'Race.location_text'to 'Race.location'
        db.rename_column(u'races_race', 'location_text', 'location')
