...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Race.enable_comments'
        db.add_column(u'races_race', 'enable_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Race.enable_comments'
        db.delete_column(u'races_race', 'enable_comments')
    ...
    models = {
        ...
        u'races.result': {
            ...
            'course_record': ('django.db.models.fields.BooleanField', [], {}),
            'dnf': ('django.db.models.fields.BooleanField', [], {}),
            'dns': ('django.db.models.fields.BooleanField', [], {}),
            'dq': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
