...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Race.location'
        db.alter_column(u'races_race', 'location', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Race.location'
        raise RuntimeError("Cannot reverse this migration. 'Race.location' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Race.location'
        db.alter_column(u'races_race', 'location', self.gf('django.db.models.fields.TextField')())
