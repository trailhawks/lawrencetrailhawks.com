...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('races_race', 'distance', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Race.slogan'
        db.alter_column('races_race', 'slogan', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):
        # Changing field 'Race.distance'
        db.alter_column('races_race', 'distance', self.gf('django.db.models.fields.CharField')(max_length=10))

        # User chose to not deal with backwards NULL issues for 'Race.slogan'
        raise RuntimeError("Cannot reverse this migration. 'Race.slogan' and its values cannot be restored.")
