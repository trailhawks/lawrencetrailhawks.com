...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field race_directors on 'Race'
        db.create_table('races_race_race_directors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('race', models.ForeignKey(orm['races.race'], null=False)),
            ('member', models.ForeignKey(orm['members.member'], null=False))
        ))
        db.create_unique('races_race_race_directors', ['race_id', 'member_id'])


    def backwards(self, orm):
        # Removing M2M table for field race_directors on 'Race'
        db.delete_table('races_race_race_directors')
    ...
    models = {
        ...
        'races.race': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'race_contacts'", 'to': "orm['members.Member']"}),
            ...
            'race_directors': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['members.Member']", 'symmetrical': 'False'}),
