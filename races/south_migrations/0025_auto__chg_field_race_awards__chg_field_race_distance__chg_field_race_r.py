...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Race.awards'
        db.alter_column(u'races_race', 'awards', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Race.distance'
        db.alter_column(u'races_race', 'distance', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Race.reg_description'
        db.alter_column(u'races_race', 'reg_description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Race.awards'
        raise RuntimeError("Cannot reverse this migration. 'Race.awards' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Race.awards'
        db.alter_column(u'races_race', 'awards', self.gf('django.db.models.fields.CharField')(max_length=300))

        # User chose to not deal with backwards NULL issues for 'Race.distance'
        raise RuntimeError("Cannot reverse this migration. 'Race.distance' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Race.distance'
        db.alter_column(u'races_race', 'distance', self.gf('django.db.models.fields.CharField')(max_length=100))

        # User chose to not deal with backwards NULL issues for 'Race.reg_description'
        raise RuntimeError("Cannot reverse this migration. 'Race.reg_description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Race.reg_description'
        db.alter_column(u'races_race', 'reg_description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'locations.location': {
            ...
            'zoom': ('django.db.models.fields.IntegerField', [], {'default': "'15'", 'null': 'True', 'blank': 'True'})
        },
        u'members.member': {
        ...
        u'races.race': {
            ...
            'awards': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            ...
            'distance': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'reg_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
