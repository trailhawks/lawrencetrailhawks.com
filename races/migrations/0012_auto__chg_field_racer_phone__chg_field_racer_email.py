...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Racer.phone'
        db.alter_column('races_racer', 'phone', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))

        # Changing field 'Racer.email'
        db.alter_column('races_racer', 'email', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Racer.phone'
        db.alter_column('races_racer', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=13))

        # Changing field 'Racer.email'
        db.alter_column('races_racer', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
