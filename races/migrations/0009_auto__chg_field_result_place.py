...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('races_result', 'place', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Result.place'
        db.alter_column('races_result', 'place', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
