...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Race.contact'
        db.delete_column('races_race', 'contact_id')

        # Adding M2M table for field contacts on 'Race'
        db.create_table('races_race_contacts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('race', models.ForeignKey(orm['races.race'], null=False)),
            ('member', models.ForeignKey(orm['members.member'], null=False))
        ))
        db.create_unique('races_race_contacts', ['race_id', 'member_id'])

    def backwards(self, orm):

        # Adding field 'Race.contact'
        db.add_column('races_race', 'contact', self.gf('django.db.models.fields.related.ForeignKey')(default=37, to=orm['members.Member']), keep_default=False)

        # Removing M2M table for field contacts on 'Race'
        db.delete_table('races_race_contacts')
    ...
    models = {
        ...
        'members.member': {
            'Meta': {'ordering': "['-date_paid']", 'object_name': 'Member'},
        ...
        'races.race': {
            ...
            'contacts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'contacts'", 'symmetrical': 'False', 'to': "orm['members.Member']"}),
